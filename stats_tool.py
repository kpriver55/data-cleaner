...
class StatisticalAnalysisTool:
    ...
    def percentiles(
        ...
        df: pd.DataFrame,
        column: str,
        percentiles: List[float] = [5, 10, 25, 50, 75, 90, 95, 99],
    ) -> Dict[str, float]:
        """
    ...
    def correlation_matrix(
        self, df: pd.DataFrame, columns: Optional[List[str]] = None, method: str = "pearson"
    ) -> pd.DataFrame:
        """
    ...
    def normality_test(self, df: pd.DataFrame, column: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                "interpretation": (
                    "Normal distribution" if p_value > 0.05 else "Not normal distribution"
                ),
    ...
    def value_counts(
        self, df: pd.DataFrame, column: str, normalize: bool = False, top_n: Optional[int] = None
    ) -> Dict[str, Any]:
        """
...
if __name__ == "__main__":
    ...
    sample_data = pd.DataFrame(
        {
            ...
            "with_outliers": np.concatenate(
                [np.random.normal(50, 10, 995), [200, 300, -100, 400, 500]]
            ),
    ...
    print(
        f"Dataset: {report['dataset_info']['total_rows']} rows, {report['dataset_info']['numeric_columns']} numeric columns"
    )
